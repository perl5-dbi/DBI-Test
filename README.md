...
Contributing
  ...
  1. DBI development mailing list
     http://lists.perl.org/list/dbi-dev.html
...
Some background and plans
  ...
  What the end-user sees:
      http://tux.nl/Talks/DBI-Test/images/dbi-dbd.png
  How that is currently tested:
    http://tux.nl/Talks/DBI-Test/images/testing.png
  What the new plan would be:
    http://tux.nl/Talks/DBI-Test/images/dbi-api.png
  ...
  that won't be part of te distribution.
