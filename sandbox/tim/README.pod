...
different to plugins for *test case* generation.  (Generated tests are "test
cases" x "test variants".)
...
TODO Work out how we namsepace, distribute, package, install and use tests from multiple sources.
